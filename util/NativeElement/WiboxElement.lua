...
for provider,widget_types in pairs(WiboxElement.widgets) do for widget_type,widgets in pairs(widget_types) do for widget_name,widget in pairs(widgets) do 
...
table.insert(components,widget_full_name .. ".vertical") elseif widget.month and widget.year then 
table.insert(components,widget_full_name .. ".month")
table.insert(components,widget_full_name .. ".year") else 
(widget_type == "mod" and error or warn)(string.format("Widget %s has no __call or horizontal/vertical",widget_full_name)) end end end end end
