local function assert_can_get_local() assert(debug,"Cannot use inline parser: debug global does not exist")
...
local index=1
while true do local var_name,var_value=debug.getlocal(stack,index)
