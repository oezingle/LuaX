...
return token end
local function bake_tokens() local tokens={{["pattern"] = "return%s*%[(=*)%[%s*<",["replacer"] = "return ",["end_pattern"] = "%s*%]%1%]",["end_replacer"] = ""},{["pattern"] = "LuaX%s*%(%[(=*)%[%s*<",["replacer"] = "",["end_pattern"] = "%s*%]%1%]%s*%)",["end_replacer"] = ""}}
