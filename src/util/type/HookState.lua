...
---@alias HookState.Listener fun(index: number, value: any)

---@class HookState : Log.BaseFunctions
---@field index number
---@field values any[]
---@field listeners HookState.Listener[]
...
---@param listener HookState.Listener
